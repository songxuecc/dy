            ...
            <el-form-item label="承诺发货时间:" prop="delivery_delay_day" v-if="template.model.presell_type === 0">
                <div style="display:flex">
                  <el-select v-model="template.model.delivery_delay_day" placeholder="请选择" size="small" default-first-option style="width:150px;margin-right:10px;align-items:center">
                    ...
                    <el-option :value="10">10天 <span class="fail">仅支持特殊类目</span><span class="fail">选择</span></el-option>
                    <el-option :value="15">15天 <span class="fail">仅支持特殊类目</span><span class="fail">选择</span></el-option>
                </el-select>
                <span class="info" style="line-height:16px;flex:1" v-if="template.model.delivery_delay_day !==2">
                  注：目前抖店官方对发货模式及发货时限规则开始调整，若选择现货发货模式，需在消费者下单后<span class="fail">&nbsp;&nbsp;2天&nbsp;&nbsp;</span>内发货。部分特殊类目可自主设置【2-15天】的发货时间，具体类目以商家后台展示为准。点击查看&nbsp;&nbsp;<el-link @click="open" type="primary" style="font-size:12px" :underline="false">官方文档</el-link>&nbsp;&nbsp;说明  。
                </span>
                </div>
