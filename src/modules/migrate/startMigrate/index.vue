  ...
  <div style="position: relative;">
    ...
    <span
      ...
      style="
        ...
        top: 56px;
        z-index:1"
      v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/alvq8l'"><hh-icon type="iconwenhao" ></hh-icon>多商品复制教程</span>
    <span
      class="click mr-20 pointer"
      ...
      style="
        ...
        top: 56px;
        z-index:1"
      v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/tm5odl'"><hh-icon type="iconwenhao" ></hh-icon>整店复制教程</span>
    <span
      class="click mr-20 pointer"
      ...
      style="
        ...
        top: 56px;
        z-index:1"
      v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/dsibrc'"><hh-icon type="iconwenhao" ></hh-icon>绑定复制教程</span>
