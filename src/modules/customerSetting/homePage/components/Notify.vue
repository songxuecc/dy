      ...
      <div class="left">
        ...
        <div class="flex">
            <div class="mt-5 mr-20 ">
                <div class="click font-12 mb-5 l-14"  style="color:#3277FF" v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/alvq8l'">01新手必读:多商品复制教程</div>
                <div class="click font-12 l-14"  style="color:#3277FF" v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/qyqwt0'">02如何批量修改商品?</div>
            </div>
            <div class="mt-5">
                <div  class="click font-12 mb-5 l-14"  style="color:#3277FF" v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/muvtyt'">03如何获取抖音复制链接?</div>
                <div  class="click font-12 l-14"  style="color:#3277FF" v-hh-open="'https://www.yuque.com/huxiao-rkndm/ksui6u/tm5odl'">04怎么获取整店复制链接?</div>
            </div>
        </div>
      </div>
    </div>
