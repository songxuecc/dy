<template>
  ...
  >
    ...
    <span>
      ...
      <span class="click mr-20 pointer" style="align-content:right" v-hh-open="'https://meideng.yuque.com/huhuguanjia/gl647x/lzteg9'"><hh-icon type="icontishi-dengpao" ></hh-icon>导入表格修改教程</span>
    </span>
