...
export default {
  ...
  computed: {
    ...mapState('productManagement/detectDuplicateProducts/tableRecordDetail', [
      'tableData',
      'total',
      'pagination',
      'filters'
    ...
    ...mapState({
      loading: state => state['@@loading'].effects['productManagement/detectDuplicateProducts/tableRecordDetail/fetch']
    })
  },
  watch: {
  ...
  methods: {
    ...mapActions('productManagement/detectDuplicateProducts/tableRecordDetail', [
      'fetch',
      'handleCurrentChange',
      'handleSizeChange'
    ]),
    ...mapMutations('productManagement/detectDuplicateProducts/tableRecordDetail', ['save']),
    getData (data) {
