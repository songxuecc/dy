...
<template>
  <el-dialog :visible.sync="visible" :show-close="false" width="520px">
    ...
    <div slot="footer" class="center">
      <el-button type="primary" plain style="width:120px" @click="cancel">暂不修改</el-button>
      <el-button type="primary" style="width:120px" @click="confirm">继续修改</el-button>
    </div>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    confirm () {
      this.cancel()
      this.$emit('continueIdProductList', this.ids)
    },
