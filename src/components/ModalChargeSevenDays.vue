<template>
  <el-dialog
    :visible.sync="modalChargeSevenDaysVisible"
    append-to-body
    width="600px"
    class="versionUp"
    :show-close="false"
...
export default {
  ...
  computed: {
    ...mapState('migrate/readyToMigrate', ['userVersion', 'versionType', 'modalChargeData', 'modalChargeSevenDaysVisible'])
  },
  methods: {
    ...
    open () {
      ...
      this.save({
        modalChargeSevenDaysVisible: !this.modalChargeSevenDaysVisible
      })
    },
    close () {
      this.save({
