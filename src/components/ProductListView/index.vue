            ...
            <el-table-column v-if="isSyncSource" label="最近同步" width="100">
             ...
             <el-table-column v-if="!isSyncSource"  width="150" style="overflow:auto"  align="center" class-name="cell-class">
                <template slot="header" slot-scope="scope">
                    <span>
                      状态
                      <span class="right click" style="margin-left:auto;margin-right:10px;font-weight: 400; font-size: 12px;" v-hh-open="'https://meideng.yuque.com/books/share/0b65c4cb-9f2a-4099-bb6e-9415844b7ccf/ut7l6p'">
                    ...
                    <div style="text-decoration:none;"  class="font-13">
                      ...
                      <span style="max-width: 50px;" manual :value="scope.row.index === mouseOverIndex" v-else-if="scope.row.status === 7" :disabled="scope.row.status !== 7" class="item" effect="dark" placement="top">
                          <div slot="content">
                            ...
                            <span v-if="scope.row.migration_msg.length === 1 && scope.row.migration_msg[0].length===0" style="padding: 0; margin: 0;" class="font-13">商品可能仓库中（已下架），如需帮助请 <a href="/service" style="color: #409EFF;">联系客服</a>。</span>
                          </div>
                      </span>
